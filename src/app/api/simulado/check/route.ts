...
// Checagem em tempo real de uma resposta DADA durante o simulado (primeira
// tentativa, igual ao reforço) — ao contrário de /reveal, aqui o usuário de
// fato respondeu, então o resultado real (certo/errado) é gravado tal como é.
export async function POST(req: NextRequest) {
  ...
  if (insertError) {
    console.error('[simulado/check] falha ao gravar log:', insertError.message)
  }
